...
export type Database = {
  public: {
    ...
    Enums: {
      ...
      comm_type: 'rx_reminder' | 'rx_received' | 'rx_approved' | 'rx_rejected' | 'order_shipped' | 'return_approved' | 'return_shipped' | 'welcome' | 'drop_launch' | 'review_request' | 'rx_escalation' | 'waitlist_notify' | 'membership_welcome' | 'slot_unlocked' | 'pair_shipped' | 'expiry_warning' | 'renewal_offer' | 'pair_fallback' | 'other';
